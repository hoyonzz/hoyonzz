...
Python · Django · FastAPI 기반 백엔드와 LLM 파이프라인을 직접 설계하고 배포해 운영합니다.

- ⚙️ GitHub Actions 스케줄 워크플로로 채용공고 ETL 파이프라인 102회 자동 실행 (실패 2건, 상시 서버 없이 운영) (2025~)
- 🤖 LLM 비서 서비스 Aiuto — v1 운영 경험을 바탕으로 FastAPI·Celery 기반으로 재설계, 요청 접수와 LLM 처리를 분리한 비동기 구조 구현
...
| [web-crawler](https://github.com/hoyonzz/web-crawler) | 룰 기반 1차 + LLM 2차 분석의 2-Step 채용공고 ETL 파이프라인 (102회 자동 실행) | Python, Selenium, GitHub Actions, Gemini API |
